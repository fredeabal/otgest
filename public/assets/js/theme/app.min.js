...
const AdminSettings = {
  ...
  ManageDarkThemeLayout() {
    // Verificar si hay un tema definido por el usuario antes de aplicar el valor estático
    const userPreferredTheme = document.documentElement.getAttribute('data-user-theme') ||
                               localStorage.getItem('theme') || 
                               'system';
    
    // Resolver "system" a light/dark según preferencia del navegador
    let resolvedTheme = userPreferredTheme;
...
// Initialize settings
// AdminSettings.AdminSettingsInit(); // Comentado para evitar conflicto de inicialización temprana
