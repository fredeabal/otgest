// =================================================================================
// Inicialización de DataTables API con idioma español
// =================================================================================

// Este archivo inicializa las tablas DataTables usando la API y configura el idioma español
// para todos los ejemplos, asegurando una experiencia consistente en la interfaz.

// Ejemplo de inicialización básica con idioma español
$('#api_example').DataTable({
  language: {
    url: "../assets/js/datatable/Spanish.json"
  }
});

// Inicialización con opciones avanzadas y español
$('#api_advanced').DataTable({
  paging: true,
  searching: true,
  ordering: true,
  language: {
...
// Inicialización con callbacks y español
$('#api_callback').DataTable({
  language: {
    url: "../assets/js/datatable/Spanish.json"
  },
  initComplete: function () {
    // Ejemplo: mostrar alerta cuando la tabla está lista
    // alert('Tabla inicializada');
  }
});

// Inicialización con botones y español
$('#api_buttons').DataTable({
  dom: 'Bfrtip',
...
// Inicialización con scroll y español
$('#api_scroll').DataTable({
  scrollX: true,
  language: {
    url: "../assets/js/datatable/Spanish.json"
  }
...
// Puedes agregar más inicializaciones según tus necesidades, siempre usando la ruta correcta para el idioma.
